...
export const EN_DICTIONARY: TranslationDictionary = {
    ...
    "referenceCollector.stagedAction": "Staged {count} references. Add them all when ready.",
    "referenceCollector.title": "{count} staged references, ready to add together",
    ...
    "referenceCollector.pendingName": "Reference being added",
    "referenceCollector.pendingBadge": "Adding",
    "referenceCollector.adding": "Adding reference image...",
    "referenceCollector.addingDuplicate": "This image is already being added",
    "referenceCollector.addedOne": "Reference image added",
    "referenceCollector.addOneFailed": "Failed to add reference. Try again.",
    "referenceCollector.addingAll": "Adding {current}/{total}",
    "referenceCollector.waitForPending": "A reference image is still being added. Try again in a moment.",
    ...
    "preview.addingReference": "Adding...",
    "preview.stage": "Stage",
    ...
    "userGuide.open": "Guide",
    "userGuide.title": "Guide",
    "userGuide.subtitle": "Find the steps for your current task while you work.",
    "userGuide.close": "Close guide",
    "userGuide.search": "Search guide",
    "userGuide.sections": "Guide sections",
    "userGuide.quickStart": "Quick Start",
    "userGuide.quickStart.1": "Upload or paste images, or click “Add reference” from a result.",
    "userGuide.quickStart.2": "Describe the image you want to generate or edit in the prompt box.",
    "userGuide.quickStart.3": "Choose size, ratio, orientation, quantity, quality, and output format.",
    "userGuide.quickStart.4": "Click “Generate” or “Edit”.",
    "userGuide.quickStart.5": "Preview results on the right, then download, view prompt, stage, or add a result back as a reference.",
    "userGuide.workspace": "Page Areas",
    "userGuide.workspace.history": "History: view recent tasks and filter by time, ratio, orientation, mode, and resolution.",
    "userGuide.workspace.references": "Reference area: upload, paste, clear, or add images from results.",
    "userGuide.workspace.prompt": "Prompt area: describe the image and insert gallery references, color codes, or prompt snippets.",
    "userGuide.workspace.settings": "Settings: control mode, size, ratio, resolution, quantity, quality, format, and moderation.",
    "userGuide.workspace.preview": "Preview: view outputs, download, stage, add references, and inspect prompts.",
    "userGuide.workspace.top": "Top status: check queue, notifications, theme, and this guide.",
    "userGuide.gallery": "Gallery",
    "userGuide.gallery.1": "Use the gallery for references you reuse often, such as portraits, characters, products, and brand assets.",
    "userGuide.gallery.2": "After saving to the gallery, you can use the image again without uploading it repeatedly.",
    "userGuide.gallery.3": "Organize images by type, such as portrait, character, or product.",
    "userGuide.gallery.4": "If a result will be reused later, save it to the gallery.",
    "userGuide.gallery.5": "If it is only for the current edit, click “Add reference” directly.",
    "userGuide.templates": "Templates",
    "userGuide.templates.1": "Use templates to save prompt patterns you reuse.",
    "userGuide.templates.2": "Create templates for scenes like portraits, product shots, posters, or style rewrites.",
    "userGuide.templates.3": "After applying a template, adjust the wording before generating.",
    "userGuide.templates.4": "Save prompt text as a template when you reuse it often.",
    "userGuide.templates.5": "For one-off descriptions, type directly in the prompt box.",
    "userGuide.results": "Result Actions",
    "userGuide.results.addReference": "Add reference: send the current result back to the reference area for another edit.",
    "userGuide.results.stage": "Stage: collect results first, then add them together later.",
    "userGuide.results.prompt": "Prompt: view the prompt used for this result.",
    "userGuide.results.download": "Download: save the image locally.",
    "userGuide.results.refresh": "Refresh: reload the current task results.",
    "userGuide.faq": "FAQ",
    "userGuide.faq.addReference": "Why does “Add reference” take a moment? The result must be prepared as an editable reference. The new UI shows “Adding” immediately.",
    "userGuide.faq.runDisabled": "Why is “Generate” unavailable? A task may be submitting, or the same task may already be active.",
    "userGuide.faq.gallery": "When should I use the gallery? Save images you reuse often.",
    "userGuide.faq.stage": "When should I stage results? Stage when you want to pick several results and add them together.",
    "userGuide.faq.templates": "When should I use templates? Save prompt patterns you reuse often."
};
