...
export const ZH_CN_DICTIONARY: TranslationDictionary = {
    ...
    "referenceCollector.stagedAction": "已暂存 {count} 张，可一次性加入参考图",
    "referenceCollector.title": "已暂存 {count} 张，可一次性加入参考图",
    ...
    "referenceCollector.pendingName": "加入中的参考图",
    "referenceCollector.pendingBadge": "加入中",
    "referenceCollector.adding": "正在加入参考图...",
    "referenceCollector.addingDuplicate": "这张图正在加入参考图",
    "referenceCollector.addedOne": "已加入参考图",
    "referenceCollector.addOneFailed": "加入参考图失败，请重试",
    "referenceCollector.addingAll": "{current}/{total} 加入中",
    "referenceCollector.waitForPending": "参考图正在加入中，请稍后再生成",
    ...
    "userGuide.open": "操作手册",
    "userGuide.title": "操作手册",
    "userGuide.subtitle": "按你的当前任务查看用法，边看边做。",
    "userGuide.close": "关闭操作手册",
    "userGuide.search": "搜索使用问题",
    "userGuide.sections": "操作手册章节",
    "userGuide.quickStart": "快速上手",
    "userGuide.quickStart.1": "上传、粘贴图片，或从右侧结果点击“加入参考图”。",
    "userGuide.quickStart.2": "在提示词框描述你想生成或编辑的画面。",
    "userGuide.quickStart.3": "选择尺寸、比例、方向、数量、质量和输出格式。",
    "userGuide.quickStart.4": "点击“开始生成”或“开始编辑”。",
    "userGuide.quickStart.5": "在右侧预览结果，可下载、查看提示词、暂存，或继续加入参考图二次编辑。",
    "userGuide.workspace": "页面区块说明",
    "userGuide.workspace.history": "左侧历史：查看最近任务，也可以按时间、比例、方向、模式和分辨率筛选。",
    "userGuide.workspace.references": "参考图区：放本次要参考的图片，支持上传、粘贴、清空和从结果加入。",
    "userGuide.workspace.prompt": "提示词区：写清楚画面要求，也可以插入常用图库、颜色码和提示词片段。",
    "userGuide.workspace.settings": "参数区：控制生成模式、尺寸、比例、分辨率、数量、质量、格式和审核等级。",
    "userGuide.workspace.preview": "预览结果：查看生成图，支持下载、暂存、加入参考图和查看提示词。",
    "userGuide.workspace.top": "顶部状态：查看队列、通知、主题和操作手册。",
    "userGuide.gallery": "公用库操作",
    "userGuide.gallery.1": "公用库适合保存常用参考图，例如固定人像、角色、商品、品牌素材。",
    "userGuide.gallery.2": "保存到公用库后，下次可以直接选择使用，不需要重复上传。",
    "userGuide.gallery.3": "可以按类型整理图片，例如人像、角色、产品。",
    "userGuide.gallery.4": "如果一张结果图后续还想反复使用，建议先保存到公用库。",
    "userGuide.gallery.5": "如果只想临时用于当前这次编辑，直接点“加入参考图”即可。",
    "userGuide.templates": "模板库操作",
    "userGuide.templates.1": "模板库适合保存常用提示词写法。",
    "userGuide.templates.2": "常用场景可以做成模板，例如人像写真、商品图、海报图、风格改写。",
    "userGuide.templates.3": "使用模板后，可以继续修改文字，再点击生成。",
    "userGuide.templates.4": "如果一段提示词经常复用，建议保存为模板。",
    "userGuide.templates.5": "如果只是一次性描述，直接在提示词框输入即可。",
    "userGuide.results": "结果区操作",
    "userGuide.results.addReference": "加入参考图：把当前结果放回左侧参考图区，继续二次编辑。",
    "userGuide.results.stage": "暂存：先收集结果，稍后一次性加入参考图。",
    "userGuide.results.prompt": "提示词：查看这张结果使用的提示词。",
    "userGuide.results.download": "下载：保存图片到本地。",
    "userGuide.results.refresh": "刷新：重新加载当前任务结果。",
    "userGuide.faq": "常见问题",
    "userGuide.faq.addReference": "点“加入参考图”后为什么要等一下：系统需要把结果图整理成可编辑参考图，新版会立即显示“加入中”。",
    "userGuide.faq.runDisabled": "“开始生成”按钮不能点：可能正在提交任务，或已有相同任务在处理中。",
    "userGuide.faq.gallery": "什么时候用公用库：经常复用的图片放公用库。",
    "userGuide.faq.stage": "什么时候用暂存：想先挑几张结果，再统一加入参考图。",
    "userGuide.faq.templates": "什么时候用模板库：经常复用的一类提示词放模板库。"
};
