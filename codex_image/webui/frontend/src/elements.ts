...
export function createWebUIElements(): WebUIElements {
  ...
  userGuideDrawer: document.querySelector("#userGuideDrawer"),
  userGuideBackdrop: document.querySelector("#userGuideBackdrop"),
  userGuideClose: document.querySelector("#userGuideClose"),
  userGuideSearch: document.querySelector("#userGuideSearch"),
  userGuideNav: document.querySelector("#userGuideNav"),
  userGuideBody: document.querySelector("#userGuideBody"),
